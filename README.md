提示された要件（概要、使用技術、Demo画面、その他説明）をすべて満たし、かつ先ほどのMermaid記法エラーも修正した、提出用に最適な `README.md` を作成しました。

以下のマークダウンをコピーして、GitHubの `README.md` にそのまま貼り付けてください。
※ **「Demo」セクションの画像パスだけは、ご自身でスクリーンショットを撮影して差し替える必要があります。**
